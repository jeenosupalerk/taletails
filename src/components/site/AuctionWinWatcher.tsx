        ...
        <DialogContent className="max-w-sm rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription className="text-center text-sm">
              กรุณาชำระเงินภายในเวลาที่กำหนด หากเลยเวลา รายการจะถูกยกเลิกและการ์ดจะรอให้ทีมงานเปิดประมูลใหม่
              พร้อมบันทึกประวัติผิดนัดของบัญชีคุณ (ครั้งที่ 2 ห้ามประมูล 7 วัน • ครั้งที่ 3 ห้ามประมูล 30 วัน)
            </DialogDescription>
          </DialogHeader>
